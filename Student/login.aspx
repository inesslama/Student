...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center ">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <h1 class="text-light"><a href="index.aspx"><span>TEK-UP </span> </a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="active " href="Student.aspx">Home</a></li>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form runat="server">
                         ...
                         <div class="form-outline mb-4">
                                ...
                                <asp:TextBox ID="StudentId" type="text"
                                    placeholder="Enter Your ID" runat="server" class="form-control form-control-lg" ></asp:TextBox>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <asp:TextBox ID="input1" type="email"
                                    placeholder="Enter email" runat="server" class="form-control form-control-lg" ></asp:TextBox>
                            ...
                            <div class="form-outline mb-3" >
                             ...
                             <asp:TextBox ID="input2" type="password" 
                                       placeholder="Enter password" runat="server" class="form-control form-control-lg"></asp:TextBox>
                            </div>
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2" >
                               ...
                               <asp:Button OnClick="login_Click"  id="login"    style="padding-left: 2.5rem; padding-right: 2.5rem;" runat="server" Text="login"  class="btn btn-primary btn-lg"
                                    type="button-log" />
